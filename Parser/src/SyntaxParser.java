...
public class SyntaxParser {
    ...
    static public HashMap<String, String> isValidCfg(String[] arguments) {
        if (arguments.length != 3) {
            logger.severe(MsgInLog.INCORRECT_NUM_OF_ARGUMENTS.msg);
            return null;
        }
        ...
        logger.info(MsgInLog.START_PARS.msg + "\n" + arguments[0]);
        ...
        try {
            ...
            while (line != null) {
                if (line.matches("[ ]*[a-zA-z_][a-zA-Z_0-9]*[ ]*" + arguments[1]
                    ...
                    logger.info(MsgInLog.INVALID_EXPRESSION.msg + ": " + line);
                }
            ...
            logger.severe(MsgInLog.NO_CONFIG_FILE.msg);
        }
        catch(IOException ex) {
            logger.severe(MsgInLog.CONFIG_GRAMMAR_ERROR.msg);
        }
        return validMap;
